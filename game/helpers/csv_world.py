...
file_path = os.path.join(os.path.dirname(__file__), "../../export/basic_4_Boundaries grass.csv")
...
file_path = os.path.join(os.path.dirname(__file__), "../../export/basic_4_Path.csv")
with open(file_path, newline='') as id_tiles:
    reader = csv.reader(id_tiles, delimiter=',')
